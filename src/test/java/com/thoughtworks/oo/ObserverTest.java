...
public class ObserverTest {
    ...
    public void should_introduce_relevant_mess_to_2class_when_change_classNumber(){
        ...
        Student studentOne1 = new Student("Bro", 18, 2, studentSubjectOne);
        Student studentOne2 = new Student("FF", 17, 2, studentSubjectOne);
        Teacher teacherOne = new Teacher("JS", 28,2,  studentSubjectOne);

        Student studentTwo1 = new Student("AA", 18, 3, studentSubjectOne);
        Student studentTwo2 = new Student("FF", 17, 3, studentSubjectOne);
        Teacher teacherTwo = new Teacher("JS", 28,3,  studentSubjectOne);
        ...
        studentSubjectOne.deleteObserver(studentOne1);
        ...
        studentSubjectOne.setNewIntroduceMess("Bro", 18, 3);
        studentSubjectTwo.setNewIntroduceMess("Bro", 18, 3);
    }
}
